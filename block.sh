...
iptables -D INPUT -p tcp --dport 2222 -m set ! --match-set greatbritain-ipv4 src -j DROP
...
ipset create greatbritain-ipv4 hash:net family inet
ipset create greatbritain-ipv6 hash:net family inet6
...
wget -nv -P /tmp/ipblocks/ipv4/ https://www.ipdeny.com/ipblocks/data/aggregated/gb-aggregated.zone
...
wget -nv -P /tmp/ipblocks/ipv6/ https://www.ipdeny.com/ipv6/ipaddresses/aggregated/gb-aggregated.zone
